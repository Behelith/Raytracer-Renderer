...
CameraPerspective::CameraPerspective(float3 location, float3 direction, float3 up, float fov) 
{
...
void CameraPerspective::LookAt(float3 target)
{
	m_target = target;
	m_direction = m_location - m_target;
...
void CameraPerspective::RenderImage(RenderContext& bitmap, Sphere * objects)
{
